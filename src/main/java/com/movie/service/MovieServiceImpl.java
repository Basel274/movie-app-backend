...
public class MovieServiceImpl implements MovieService{
    ...
    public MovieDto addMovie(MovieDto movieDto, MultipartFile file) throws IOException {
        ...
        if (Files.exists(Paths.get(path + File.separator + file.getOriginalFilename()))){
            throw new FileExistsException("File already exists, Please enter file name");
        }
       String uploadedFileName = fileService.uploadFile(path, file);

        // 2. set the value of the field 'poster' to the filename
        movieDto.setPoster(uploadedFileName);

        // 3. map dto to the movie object
    ...
    public MovieDto getMovie(Integer movieId) {
       ...
       Movie movie = movieRepository.findById(movieId)
        ...
        // 3. map it to movieDto and return it
        MovieDto response = new MovieDto(
                movie.getMovieId(),
                movie.getTitle(),
                movie.getDirector(),
    ...
    public List<MovieDto> getAllMovies() {
        ...
        // 2. iterate through the list, generate posterUrl for each movie obj, and map it to movieDto obj
    ...
    public MovieDto updateMovie(Integer movieId, MovieDto movieDto, MultipartFile file) throws IOException {
        ...
        // 1. check if the movie object already exists with given movieId
        Movie mv = movieRepository.findById(movieId)
                .orElseThrow(() -> new MovieNotFoundException("Movie not found with id= " + movieId));

        // 2. if the file is null, do nothing
        // if file is not null, then delete the existing file, and upload the new file
        ...
        // 7. map it to movieDto -> return it
        MovieDto response = new MovieDto(
                movie.getMovieId(),
                movie.getTitle(),
                movie.getDirector(),
    ...
    public String deleteMovie(Integer movieId) throws IOException {
        ...
        // 3. delete this movie object
        movieRepository.delete(mv);

        return "movie deleted with movie id: " + id;
    }
    ...
    public MoviePageResponse getAllMoviesWithPagination(Integer pageNumber, Integer pageSize) {
        ...
        for (Movie movie : movies) {
            ...
            return new MoviePageResponse(moviesDto, pageNumber, pageSize,
